...
public class EquivalenceClass{
    ...
    public static void main(String[] args) {
        ...
        AttributeAndDirection B = AttributeAndDirection.getInstance(1,AttributeAndDirection.UP);
        AttributeAndDirection C = AttributeAndDirection.getInstance(2,AttributeAndDirection.UP);
        ...
        ode.mergeNodeTest(A, data, ODTree.ODTreeNodeStatus.VALID);
        ode.mergeNodeTest(C, data, ODTree.ODTreeNodeStatus.VALID);
        System.out.println(ode);
        System.out.println(ode.check(data).status);


        ODTreeNodeEquivalenceClasses ode1 = new ODTreeNodeEquivalenceClasses();
        ode1.mergeNodeTest(B, data, ODTree.ODTreeNodeStatus.SPLIT);
        ode1.mergeNodeTest(A, data, ODTree.ODTreeNodeStatus.VALID);
        System.out.println(ode1);
        System.out.println(ode1.check(data).status);


        ODTreeNodeEquivalenceClasses ode2 = new ODTreeNodeEquivalenceClasses();
        ode2.mergeNodeTest(B, data, ODTree.ODTreeNodeStatus.SPLIT);
        ode2.mergeNodeTest(A, data, ODTree.ODTreeNodeStatus.VALID);
        ode2.mergeNodeTest(C, data, ODTree.ODTreeNodeStatus.VALID);
        ode2.mergeNodeTest(D, data, ODTree.ODTreeNodeStatus.VALID);
        System.out.println(ode2);
        System.out.println(ode2.check(data).status);

        ODTreeNodeEquivalenceClasses ode3 = new ODTreeNodeEquivalenceClasses();
        ode3.mergeNodeTest(A, data, ODTree.ODTreeNodeStatus.SPLIT);
        ode3.mergeNodeTest(C, data, ODTree.ODTreeNodeStatus.VALID);
        System.out.println(ode3);
        System.out.println(ode3.check(data).status);
    }
}
